...
celltype_TF_markers <- read.delim("res/1_clustering/PAS_markers/Celltype_TF_Markers_All_Datasets.tsv")
...
TvN_TF_markers <- read.delim("res/2_TvN/DE/TvN_TF_Markers_All_Datasets.tsv")
...
path.survival <- read.csv(file = "res/6_patient_clustering/PathSurv/path.survival.csv")
tmp.text <- element_text(family="sans", size=8)
